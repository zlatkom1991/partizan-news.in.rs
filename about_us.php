        ...
        <div class="col-md-6 col-offset-2">
            ...
            <p>Portal partizan-news.in.rs online je od marta 2020. godine.<br>Portal je na usluzi svim navijačima Partizana,
             kao i svim entuzijazistima i ljubiteljima sporta, 24 časa dnevno, 365 dana u godini.<br>
              ...
              <a href="https://twitter.com/partizan_news_" target="_blank"><i class="fab fa-twitter"></i> partizan_belgrade_news</a>
              <hr>
              <h3>Kontaktirajte nas</h3>
              <p>Ukoliko imate pitanja za nas ili želite saradnju <br> možete nas kontaktirati putem naše<a href="test.php"> <span style="color:blue">kontakt forme</span></a>.</p><a href=""></a>
        </div>
